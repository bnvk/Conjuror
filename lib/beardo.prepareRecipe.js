...
Beardo.getIngredients = function(config_file, callback){
  ...
  Beardo.readManuscript(config_file)
...
// Beardo.parseCSV = function(parseCSV) {
//   csv.parse
// }

Beardo.readData = function(schema_file, callback) {
  ...
  Beardo.readManuscript(schema_file)
    .then(function(buffer) {
      ...
      Beardo.readManuscript(dataPath + '/' + clients_json[0].resources[0].path)
        .then(function(buffer) {
