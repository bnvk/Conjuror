...
argv.option({
  ...
  short: 'r',
  type: 'string',
  description: 'Points at what recipe to use.',
  example: "'conjuror.js --recipe=value' or 'conjuror.js -r create-clients'. Recipe can either be a predefined recipe, or a custom one."
})
...
argv.option({
  ...
  example: "'conjuror.js --formats=value' or 'conjuror.js -f value1,value2'"
})
...
argv.option({
  ...
  example: "'conjuror.js --message=\"a short message\"' or 'conjuror.js -m 'a short message''"
})
...
argv.option({
  ...
  short: 'g',
  type: 'string',
  description: 'Manually specify generatd date',
  example: "'conjuror.js --generated=\"8th January, 2016\"' or 'conjuror.js -g '8th January, 2016''"
})
